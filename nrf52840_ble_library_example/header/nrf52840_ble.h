#ifndef NRF52840_BLE__
#define NRF52840_BLE__
...
#define DEVICE_NAME                     "nRF52840 BLE - Zerynth Library"                         /**< Name of device. Will be included in the advertising data. */
...
#define half_page_size 2048
#define PAGE_SIZE_word 128

#define PAGE_START(x) (uint8_t*)(((x)%PAGE_SIZE==0) ? (x):((x) - ((x)%PAGE_SIZE)))
extern char softdevice_stack_enabled;
 ...
 */
extern void on_conn_params_evt(ble_conn_params_evt_t * p_evt);
...
int vhalFlashErase_with_softdevice(void *addr, uint32_t size);
